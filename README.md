...
Is simple timer application with custom alert sound. I built it while learning react.js

## Basic feature:
1. Submit your desire time by putting the numbers in the input field "Set to <> minutes"
2. If minutes are not set, then a pop-up will show up with an alert to do so.
3. After setting the minutes, press start to start the timer.
4. Once time is up, an alert window will pop-up and a "cuckoo-cuckoo-clock" sound will go off.

Open the app here: https://abelhect.github.io/pomodorotimer/
